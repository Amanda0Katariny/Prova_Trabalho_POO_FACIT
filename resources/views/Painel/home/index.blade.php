...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Laboratorio São Sebastião</title>
        ...
        <style>
            html, body {
                background: radial-gradient(ellipse at center, #f6f8f9 0%,#e5ebee 31%,#d7dee3 48%,#f6f8f9 64%,#f5f7f9 100%); /* W3C, IE10+, FF16+, Chrome26+, Opera12+, Safari7+ */                font-family: 'Nunito', sans-serif;
                color: #4c0066;
