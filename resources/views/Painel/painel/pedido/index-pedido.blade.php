                    ...
                    <thead class="thead-light">
                        ...
                        <tr>
                            ...
                            {{-- <td class="td-actions text-center" style="width:15%" >
                                ...
                                <a href="#" >
                                    {{ Form::open(['action' => ['Painel\PedidoController@destroy', $pedido->id], 'id'=>$pedido->id, 'class'=>'form-inline', 'method' => 'DELETE']) }}
                                    {{ Form::button('<i class="fa fa-trash"></i>', ['class' => 'btn btn-danger', 'type' => 'submit', 'form'=>$pedido->id, 'data-toggle'=>'tooltip', 'data-placement' =>'top', 'title' =>'Deletar'] ) }}
                                    {{ Form::close() }}
                                </a>

                                <a href="{{route('pedido.edit', $pedido->id)}}" class="btn btn-info" data-toggle="tooltip" data-placement="top" title ="Editar">
                            ...
                            <td class = "td-actions text-center">
                                ...
                                {{-- <a href="#" id="{{$pedido->id}}" class="btn btn-danger" data-toggle="modal" data-placement="top" title ="Apagar tabela">
