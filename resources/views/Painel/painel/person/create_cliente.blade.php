                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-xs-4">
                                ...
                                <!-- BASE -->
                                <div class="switch">
                                    <label>NÃO<input type="checkbox" name="teste" value="1"><span class="lever"></span>SIM</label>
                                </div>

                                <!-- USANDO checked com PHP -->
                                <div class="switch">
                                    <label>NÃO<input type="checkbox" name="teste" value="1"{{ ($teste == 1) ? ' checked' : false }}><span class="lever"></span>SIM</label>
                                </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-xs-3">
                                ...
                                {!! Form::text('CNPJ', null, ['class' => 'form-control', 'placeholder'=>'CPF/CNPJ','maxlength'=>'13','id'=>'CNPJ']) !!}
                            </div>
